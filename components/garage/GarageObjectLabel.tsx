...
export function GarageObjectLabel({ title, description }: GarageObjectLabelProps) {
  return (
    <motion.div
      ...
      className="absolute left-1/2 top-0 z-30 w-44 -translate-x-1/2 -translate-y-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-left shadow-xl"
    >
